...
public class AccountServiceTests : IClassFixture<AccountServiceFixture>
{
    ...
    public async Task DepositAsync_ThrowsArgumentException_AndDoesntCallRepository_WhenAmountIsZeroOrBelow(int accountId, decimal amount)
    {
        ...
        await Assert.ThrowsAsync<ArgumentException>(()
            => _fixture.Sut.DepositAsync(accountId, amount, "Deposit test"));
    ...
    public async Task DepositAsync_CallsGetAccountByIdAsync()
    {
        ...
        //Act
        await _fixture.Sut.DepositAsync(accountId, 5000, "Deposit test");
    ...
    public async Task DepositAsync_ThrowsInvalidOperationException_AndDoesntCallTransactionRep_WhenAccountNotFound()
    {
        ...
        //Act and Assert
        await Assert.ThrowsAsync<InvalidOperationException>(() => _fixture.Sut.DepositAsync(accountId, amount, "Deposit test"));
    ...
    public async Task DepositAsync_IncreasAndUpdatesBalance(decimal balance, decimal deposit, decimal expected)
    {
        ...
        // Act
        await _fixture.Sut.DepositAsync(accountId, deposit, "Deposit test");
...
{
    new(accountId, 50.00m, "GetTransactions test", DateTime.Now.AddDays(-1), TransactionType.Deposit),
    new(accountId, -20.00m, "GetTransactions test", DateTime.Now, TransactionType.Withdrawal),
    new(accountId, 10.00m, "GetTransactions test", DateTime.Now, TransactionType.Deposit)
};
    ...
    {
        var accountId = 1;
        await Assert.ThrowsAsync<ArgumentException>(() => _fixture.Sut.TransferAsync(accountId, accountId, 100m, "Transfer test"));
    }
    ...
    public async Task TransferAsync_ThrowsArgumentException_WhenAmountIsZeroOrNegative()
    {
        var fromId = 1;
        var toId = 2;
        await Assert.ThrowsAsync<ArgumentException>(() => _fixture.Sut.TransferAsync(fromId, toId, 0m, "Transfer test"));
        await Assert.ThrowsAsync<ArgumentException>(() => _fixture.Sut.TransferAsync(fromId, toId, -10m, "Transfer test"));
    }
    ...
    public async Task TransferAsync_ThrowsInvalidOperationException_WhenSourceAccountNotFound()
    {
        ...
        await Assert.ThrowsAsync<InvalidOperationException>(() => _fixture.Sut.TransferAsync(fromId, toId, 10m, "Transfer test"));
    }
    ...
    public async Task TransferAsync_TransfersFundsAndCreatesTransactions()
    {
        ...
        await _fixture.Sut.TransferAsync(fromId, toId, 30m, "Transfer test");
    ...
    public async Task TransferAsync_UpdatesBothAccountsAndCallsUpdateAccountAsync()
    {
        ...
        await _fixture.Sut.TransferAsync(fromId, toId, amount, "Transfer test");
        ...
        int accountId, decimal withdrawAmount)
    {
        //Act and Assert
        await Assert.ThrowsAsync<ArgumentException>(() =>
            _fixture.Sut.WithdrawAsync(accountId, withdrawAmount, "Withdraw test"));
    ...
    public async Task WitrhdrawAsync_Calls_GetAccountById_AndAddTransactionAsync(int accountId, decimal withdrawAmount)
    {
        ...
        //Act
        await _fixture.Sut.WithdrawAsync(accountId, withdrawAmount, "Withdraw test");
    ...
    public async Task WithdrawAsync_WithdrawsOnCorrectAccount_AndCallsAddTransactionAsync(decimal accountBalance, decimal withdrawAmount, decimal expected)
    {
        ...
        //Act
        await _fixture.Sut.WithdrawAsync(1, withdrawAmount, "Withdraw test");
    ...
    {
        // ARRANGE
        Account testAccount = new("BusinessAccount", accountBalance, 123, "testUserId") { AccountId = accountId };
